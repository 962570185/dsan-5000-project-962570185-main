...
- **Precision (0.8589150250548824)**: When the model predicts that a certain observation value is positive, there is an 85.89% probability that it is correct. Indicates average reliability.
- **Recall (0.8584)**: Identifies 50.4% of actual positives. Moderate performance in detecting true cases.
- **F1 Score (0.8584024638424639)**: Harmonic mean of precision and recall, indicating average balance.
